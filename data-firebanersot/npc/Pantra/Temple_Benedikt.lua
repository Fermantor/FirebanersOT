...
keywordHandler:addKeyword({"obsidian knife"}, StdModule.say, {npcHandler = npcHandler, text = {
	"Ein Obsidian Knife eignet sich hervorangend, um die Haut von get�teten Monstern zu entfernen. Es gelingt damit zwar nicht immer, aber doch deutlich h�ufiger, als dass man ein intaktes St�ck im K�rper findet. ...",
