...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'job') then
		npcHandler:say('Ich leite die Bank in Bonezone. Möchtest du dein Geld bei mir {lagern}?.', cid)
	elseif msgcontains(msg, 'vial') then
		npcHandler:say('Xantharus in Little Cotton verkauft welche. Schaue bei ihm nach.', cid)
		
	-- Bank Script fängt hier an
