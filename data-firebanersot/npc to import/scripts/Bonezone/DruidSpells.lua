...
npcHandler:setMessage(MESSAGE_GREET, 'Schön dich zu sehen, |PLAYERNAME|. In dieser Stadt kümmern sich die Frauen um die Magie.')
...
shopModule:addBuyableItem({'avalanche'}, 2274, 90, 'avalanche rune')
shopModule:addBuyableItem({'blank rune'}, 2260, 10, 'blank rune')
shopModule:addBuyableItem({'chameleon'}, 2291, 420, 'chameleon rune')
shopModule:addBuyableItem({'convince creature'}, 2290, 160, 'convince creature rune')
shopModule:addBuyableItem({'energy bomb'}, 2264, 324, 'energy bomb rune')
shopModule:addBuyableItem({'energy field'}, 2277, 76, 'energy field')
shopModule:addBuyableItem({'energy wall'}, 2279, 170, 'energy wall rune')
shopModule:addBuyableItem({'explosion'}, 2313, 62, 'explosion rune')
shopModule:addBuyableItem({'fire bomb'}, 2305, 234, 'fire bomb rune')
shopModule:addBuyableItem({'fire field'}, 2301, 56, 'fire field rune')
shopModule:addBuyableItem({'fire wall'}, 2303, 122, 'fire wall rune')
shopModule:addBuyableItem({'fireball'}, 2302, 60, 'fire ball')
shopModule:addBuyableItem({'great fireball'}, 2304, 90, 'great fireball rune')
shopModule:addBuyableItem({'heavy magic missile'}, 2311, 24, 'heavy magic missile rune')
shopModule:addBuyableItem({'holy missile missile'}, 2295, 32, 'holy missile rune')
shopModule:addBuyableItem({'icicle'}, 2271, 60, 'icicle rune')
shopModule:addBuyableItem({'intense healing'}, 2265, 190, 'intense healing rune')
shopModule:addBuyableItem({'light magic missile'}, 2287, 8, 'light magic missile rune')
shopModule:addBuyableItem({'poison bomb'}, 2286, 170, 'poison bomb rune')
shopModule:addBuyableItem({'poison field'}, 2285, 42, 'poison field')
shopModule:addBuyableItem({'poison wall'}, 2289, 104, 'poison wall rune')
shopModule:addBuyableItem({'stalagmite'}, 2292, 24, 'stalagmite rune')
shopModule:addBuyableItem({'stone shower'}, 2288, 74, 'stoneshower rune')
shopModule:addBuyableItem({'thunderstorm'}, 2315, 74, 'thunderstorm rune')
shopModule:addBuyableItem({'sudden death'}, 2268, 216, 'sudden death rune')
...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'job') or msgcontains(msg, 'beruf') then
		selfSay('Meine kleine Aufgabe als Zahnrad in diesem großen System ist es für die Wands, Rods und Runen aller Bewohner und Reisender zu sorgen. Ich denke, dass ist eine ziemlich wichtige Berufung.', cid)
	elseif msgcontains(msg, 'vial') then
		selfSay('In Little Cotton gibt es einen Mann namens Xantharus. Er verkauft Milch und Vials.', cid)
	end
    return true
end
