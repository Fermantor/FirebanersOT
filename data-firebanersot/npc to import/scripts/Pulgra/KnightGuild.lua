...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'job') or msgcontains(msg, 'beruf') then
		selfSay("Ich bin der Leiter der Knight Guilde von Pulgra. Ich lerne {spells} und {tausche} Waffen, wenn du mit deiner nicht zufrieden bist.", cid)
	...
	elseif msgcontains(msg, 'axe') then
		if getPlayerStorageValue(cid, 8602) ~= 1 then
			selfSay("Ich kann dir anbieten, dein Jagged Sword gegen eine Steel Axe zu tauschen. Einverstanden?", cid)
	...
	elseif msgcontains(msg, 'club') then
		if getPlayerStorageValue(cid, 8602) ~= 1 then
			selfSay("Ich kann dir anbieten, dein Jagged Sword gegen eine Daramanian Mace zu tauschen. Einverstanden?", cid)
