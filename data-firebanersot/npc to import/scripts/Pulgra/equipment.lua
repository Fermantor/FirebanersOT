...
shopModule:addBuyableItem({'trap'}, 2578, 280, 1,'closed trap')
...
shopModule:addSellableItem({'Brimstone Fangs'}, 12658, 380)
...
shopModule:addSellableItem({'Bunch of Troll Hair'}, 10605, 30)
shopModule:addSellableItem({'Bundle of Cursed Straw'}, 10606, 800)
shopModule:addSellableItem({'Carniphila Seeds'}, 11217, 50)
shopModule:addSellableItem({'Carrion Worm Fang'}, 11186, 35)
shopModule:addSellableItem({'Centipede Leg'}, 11192, 28)
...
shopModule:addSellableItem({'Demon Dust'}, 5906, 300)
...
shopModule:addSellableItem({'Goblin Ear'}, 12472, 20)
...
shopModule:addSellableItem({'Haunted Piece of Wood'}, 10600, 115)
...
shopModule:addSellableItem({'Mantassin Tail'}, 12445, 28)
...
shopModule:addSellableItem({'Piece of Warrior Armor'}, 12438, 50)
...
shopModule:addSellableItem({'Safety Pin'}, 12459, 120)
...
shopModule:addSellableItem({'Terrorbird Beak'}, 11190, 950)
...
shopModule:addSellableItem({'Tusk'}, 8614, 100)
...
shopModule:addSellableItem({'Werewolf Fur'}, 11228, 380)
...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'job') or msgcontains(msg, 'beruf') then
		npcHandler:say('Mein job ist es, backpack und nützliche Tools zu verkaufen. Schau doch einfach mal bei einem {trade} vorbei.',cid)
	end
